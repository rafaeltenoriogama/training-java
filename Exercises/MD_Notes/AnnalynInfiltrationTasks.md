### The objective here is win a little story:
...
class AnnalynsInfiltration {
    public static boolean canFastAttack(boolean knightIsAwake) {
        // Using ! to negate the boolean, true turns into false - false turns into true.
        return !knightIsAwake;
    }

    public static boolean canSpy(boolean knightIsAwake, boolean archerIsAwake, boolean prisonerIsAwake) {
        // If at least ONE of the membes is true to be awake
        return knightIsAwake || archerIsAwake || prisonerIsAwake;
    }

    public static boolean canSignalPrisoner(boolean archerIsAwake, boolean prisonerIsAwake) {
        // Using ! to using (false plus true)[Arche asleep and prisoner awake] and && to only that is true. 
        return !archerIsAwake && prisonerIsAwake;
    }

    public static boolean canFreePrisoner(boolean knightIsAwake, boolean archerIsAwake, boolean prisonerIsAwake, boolean petDogIsPresent) {
        // Both enemys need to be asleep and prisoner awake [False, False, True = True]
        // Archer need to be asleep, Dog need to be present [False, True = True]
